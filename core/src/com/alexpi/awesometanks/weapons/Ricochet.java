...
public class Ricochet extends Weapon {
    ...
    public Ricochet(AssetManager assetManager, int ammo, int power, boolean isPlayer)  {
        super("Ricochet", assetManager, "weapons/ricochet.png", "sounds/ricochet.ogg", ammo, power, isPlayer, .5f);
    }
    @Override
